...
| **Phase 3** | Peel the rest: goals, outcomes, journal, cascade work-queue (no Protocol yet - #383; the work-queue's POSIX-rename claim is what T4 tracks). Mandate, policy, profile, tool-registry, corpus, and persona storage (`.personas/`) to Postgres adapters (#258). | Issue #383 + #258 + TENSIONS.md T4 + T13 |
