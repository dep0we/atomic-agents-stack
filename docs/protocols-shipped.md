...
Filed as [#200](https://github.com/dep0we/atomic-agents-stack/issues/200). PR 2 shipped the Protocol + ref impl. PR 3 shipped the pgvector backends + registry + opt-in guard. [#544 PR1](https://github.com/dep0we/atomic-agents-stack/issues/544) shipped the live batch embed cost gate + PRIMITIVE_EMBED + doctor check + spec addenda. LOCK ceremony deferred to #544 PR2 (query-embed gate).
