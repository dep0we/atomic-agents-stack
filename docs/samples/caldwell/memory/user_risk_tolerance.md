...
- **Investment posture:** index funds, not active picks. He doesn't want stock-selection risk. Recommended allocations should default broad-market index, not sector or style bets.
- **Debt elimination > investment optimization** (currently). Even when the math favors investing the spread, his lived risk tolerance favors paid-off-balance certainty.
- **Emergency fund target:** 6 months of essential expenses, not the 3 months "minimum" some advisors push. He sleeps better with 6.
- **No leverage strategies.** No HELOC-to-invest, no margin, no derivatives. Even when math is favorable.
