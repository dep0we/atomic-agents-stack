...
supersedes: null
superseded_by: null
tags: [income, target, q3, household]
---
...
- If Sam asks "should I do X spending?" and X delays Q3 hitting the target, surface that explicitly.
- Quarterly review of progress; mid-quarter check-ins if anything goes off-rails.

**Expires:** 2026-09-30. Re-set Q4 target before this expires.
