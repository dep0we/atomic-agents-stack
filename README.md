...
| **Numbered, locked spec** | 36 locked docs in `docs/spec/` (+ 7 DRAFTs/RFCs in progress) | API + concept docs | API + concept docs | API reference + concept docs | None |
...
- **Spec-level file layout.** 36 numbered docs lock the contract (plus 7 DRAFTs/RFCs in progress); conformance is testable; alternate implementations are possible.
