...
| **Numbered, locked spec** | 35 locked docs in `docs/spec/` (+ 5 RFCs/DRAFTs in progress) | API + concept docs | API + concept docs | API reference + concept docs | None |
...
- **Spec-level file layout.** 35 numbered docs lock the contract (plus 5 RFCs/DRAFTs in progress); conformance is testable; alternate implementations are possible.
