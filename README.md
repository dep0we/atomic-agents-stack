...
| **Numbered, locked spec** | 42 locked docs in `docs/spec/` (+ 6 DRAFTs/RFCs in progress) | API + concept docs | API + concept docs | API reference + concept docs | None |
...
- **Spec-level file layout.** 42 numbered docs lock the contract (plus 6 DRAFTs/RFCs in progress); conformance is testable; alternate implementations are possible.
