...
| `PolicyBackend` | In progress (PR 1 of 4 scaffolding shipped 2026-05-19; spec/32 RFC; PR 2 wiring next) | [`#89`](https://github.com/dep0we/atomic-agents-stack/issues/89) |
