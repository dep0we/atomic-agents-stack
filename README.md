...
| **Numbered, locked spec** | 35 locked docs in `docs/spec/` (+ 8 DRAFTs/RFCs in progress) | API + concept docs | API + concept docs | API reference + concept docs | None |
...
- **Spec-level file layout.** 35 numbered docs lock the contract (plus 8 DRAFTs/RFCs in progress); conformance is testable; alternate implementations are possible.
