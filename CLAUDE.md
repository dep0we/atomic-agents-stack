...
MCP client support shipped (PRs #55 + #56). All twelve backend protocols shipped; v1.0.0 released 2026-06-04. Single-developer project; reference implementation that anyone can use, fork, or extend.
