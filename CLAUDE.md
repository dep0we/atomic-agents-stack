...
| `docs/spec/01-...49-deploy.md` | Locked spec (48 docs today, 41 locked + 7 DRAFTs/RFCs at spec/26 (cascade bundle), spec/30 (responsibility audit), spec/37 (serve), spec/39 (otel-export), spec/47 (conversation-backend), spec/48 (principal-backend), and spec/49 (deploy)). The product. |
