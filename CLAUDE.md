...
```
       ...
       Journal              Delegation (tree-cap) OTel trace export 🟡 (#341 PR1: call span)
                  ...
                  GoalBackend ✅ (#425 PR 1 + #448 PR1/PR2/PR3 arc-closer + #483 PR1 clock-injection/shim/agent_root + #496 PR1 backend-universe alignment + #642 PR1 multi-goal/create_goal RE-LOCK, LOCKED spec/41 — the 14th, v2.0.0)
...
| `docs/spec/01-...54-fleet-console-recommendations.md` | Locked spec (53 docs today, 43 locked + 10 DRAFTs/RFCs at spec/26 (cascade bundle), spec/30 (responsibility audit), spec/37 (serve), spec/39 (otel-export), spec/49 (deploy), spec/50 (conductor), spec/51 (agent-registry-backend), spec/52 (fleet-console), spec/53 (fleet-console-scoring), and spec/54 (fleet-console-recommendations)). The product. |
