...
```
       ...
       Journal              Delegation (tree-cap)
                  ...
                  Persona 🟡  Corpus 🟡  Policy 🟡  MCPServerRegistry 🟡
                                │
...
| `docs/spec/01-...31-llm-backend.md` | Locked spec (29 docs today — 28 locked + 1 RFC at spec/30). The product. |
