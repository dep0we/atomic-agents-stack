...
| `docs/spec/01-...45-idempotency-backend.md` | Locked spec (44 docs today, 37 locked + 7 DRAFTs/RFCs at spec/26 (cascade bundle), spec/30 (responsibility audit), spec/35 (init wizard), spec/37 (serve), spec/39 (otel-export), spec/43 (journal-backend), and spec/44 (queue-backend)). The product. |
