...
```
       ...
       Journal              Delegation (tree-cap) OTel trace export 🟡 (#341 PR1: call span)
                  ...
                  EmbeddingBackend 🟡 (#200 PR 2 + #544 PR1, DRAFT spec/46 — the 19th, v1.5)
...
| 19 | EmbeddingBackend | #200 PR 2 + #544 PR1 (DRAFT spec/46) | OpenAI (OpenAIEmbeddingBackend) |
